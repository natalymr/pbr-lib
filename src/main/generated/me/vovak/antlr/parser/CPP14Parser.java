...
public class CPP14Parser extends Parser {
	...
	public final UnaryoperatorContext unaryoperator() throws RecognitionException {
		...
		try {
			...
			setState(703);
			_la = _input.LA(1);
			if ( !(_la==4 || _la==6 || ((((_la - 90)) & ~0x3f) == 0 && ((1L << (_la - 90)) & ((1L << (Plus - 90)) | (1L << (Minus - 90)) | (1L << (Star - 90)) | (1L << (And - 90)) | (1L << (Or - 90)) | (1L << (Tilde - 90)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final SimpledeclarationContext simpledeclaration() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				...
				setState(1212);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << Decltype) | (1L << Operator))) != 0) || ((((_la - 84)) & ~0x3f) == 0 && ((1L << (_la - 84)) & ((1L << (LeftParen - 84)) | (1L << (Star - 84)) | (1L << (And - 84)) | (1L << (Tilde - 84)) | (1L << (Doublecolon - 84)) | (1L << (Ellipsis - 84)) | (1L << (Identifier - 84)))) != 0)) {
					{
	...
	public final InitdeclaratorContext initdeclarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1650); declarator();
			setState(1652);
			switch ( getInterpreter().adaptivePredict(_input,169,_ctx) ) {
			case 1:
				{
				setState(1651); initializer();
				}
				break;
			}
			}
	...
	public final DeclaratorContext declarator() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1655); noptrdeclarator(0);
				setState(1656); parametersandqualifiers();
				setState(1657); trailingreturntype();
				}
				break;
			}
		}
	...
	public final PtrdeclaratorContext ptrdeclarator() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1661); noptrdeclarator(0);
				}
				break;
	...
	private NoptrdeclaratorContext noptrdeclarator(int _p) throws RecognitionException {
		...
		try {
			...
			case Identifier:
				{
				setState(1668); declaratorid();
				setState(1670);
				switch ( getInterpreter().adaptivePredict(_input,172,_ctx) ) {
				case 1:
					{
					setState(1669); attributespecifierseq(0);
					}
					break;
				}
				}
			...
			case LeftParen:
				{
				setState(1672); match(LeftParen);
				setState(1673); ptrdeclarator();
				setState(1674); match(RightParen);
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(1678);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(1679); parametersandqualifiers();
						}
						break;
					...
					case 2:
						...
						setState(1680);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(1681); match(LeftBracket);
						setState(1683);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << Alignof) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Const_cast) | (1L << Decltype) | (1L << Delete) | (1L << Double) | (1L << Dynamic_cast) | (1L << False) | (1L << Float) | (1L << Int) | (1L << Long) | (1L << New) | (1L << Noexcept) | (1L << Nullptr) | (1L << Operator) | (1L << Reinterpret_cast) | (1L << Short) | (1L << Signed) | (1L << Sizeof))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (Static_cast - 64)) | (1L << (This - 64)) | (1L << (True - 64)) | (1L << (Typeid_ - 64)) | (1L << (Typename_ - 64)) | (1L << (Unsigned - 64)) | (1L << (Void - 64)) | (1L << (Wchar - 64)) | (1L << (LeftParen - 64)) | (1L << (LeftBracket - 64)) | (1L << (Plus - 64)) | (1L << (Minus - 64)) | (1L << (Star - 64)) | (1L << (And - 64)) | (1L << (Or - 64)) | (1L << (Tilde - 64)) | (1L << (PlusPlus - 64)) | (1L << (MinusMinus - 64)))) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (Doublecolon - 128)) | (1L << (Identifier - 128)) | (1L << (Integerliteral - 128)) | (1L << (Characterliteral - 128)) | (1L << (Floatingliteral - 128)) | (1L << (Stringliteral - 128)) | (1L << (Userdefinedintegerliteral - 128)) | (1L << (Userdefinedfloatingliteral - 128)) | (1L << (Userdefinedstringliteral - 128)) | (1L << (Userdefinedcharacterliteral - 128)))) != 0)) {
							{
							setState(1682); constantexpression();
							}
						}

						setState(1685); match(RightBracket);
						setState(1687);
						switch ( getInterpreter().adaptivePredict(_input,175,_ctx) ) {
						case 1:
							{
							setState(1686); attributespecifierseq(0);
							}
							break;
						}
						}
	...
	public final ParametersandqualifiersContext parametersandqualifiers() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1694); match(LeftParen);
			setState(1695); parameterdeclarationclause();
			setState(1696); match(RightParen);
			setState(1698);
			switch ( getInterpreter().adaptivePredict(_input,178,_ctx) ) {
			case 1:
				{
				setState(1697); cvqualifierseq();
				}
				break;
			}
			setState(1701);
			...
			case 1:
				{
				setState(1703); exceptionspecification();
				}
				break;
			}
			setState(1707);
			...
			case 1:
				{
				setState(1706); attributespecifierseq(0);
				}
				break;
			}
			}
	...
	public final TrailingreturntypeContext trailingreturntype() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1709); match(Arrow);
			setState(1710); trailingtypespecifierseq();
			setState(1712);
			switch ( getInterpreter().adaptivePredict(_input,182,_ctx) ) {
			case 1:
				{
				setState(1711); abstractdeclarator();
				}
				break;
			}
			}
	...
	public final PtroperatorContext ptroperator() throws RecognitionException {
		...
		try {
			...
			case And:
				enterOuterAlt(_localctx, 2);
				{
				setState(1721); match(And);
				setState(1723);
				switch ( getInterpreter().adaptivePredict(_input,185,_ctx) ) {
				case 1:
					{
					setState(1722); attributespecifierseq(0);
					}
					break;
				}
				}
			...
			case 2:
				...
				case 1:
					{
					setState(1726); attributespecifierseq(0);
					}
					break;
				}
				}
			...
			case Identifier:
				enterOuterAlt(_localctx, 4);
				{
				setState(1729); nestednamespecifier(0);
				setState(1730); match(Star);
				setState(1732);
	...
	public final CvqualifierseqContext cvqualifierseq() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1739); cvqualifier();
			setState(1741);
			switch ( getInterpreter().adaptivePredict(_input,190,_ctx) ) {
			case 1:
				{
				setState(1740); cvqualifierseq();
				}
				break;
			}
			}
	...
	public final DeclaratoridContext declaratorid() throws RecognitionException {
		...
		try {
			...
			if (_la==Ellipsis) {
				{
				setState(1747); match(Ellipsis);
				}
			}

			setState(1750); idexpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ThetypeidContext thetypeid() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1752); typespecifierseq();
			setState(1754);
			switch ( getInterpreter().adaptivePredict(_input,192,_ctx) ) {
			case 1:
				{
				setState(1753); abstractdeclarator();
				}
				break;
			}
			}
	...
	public final AbstractdeclaratorContext abstractdeclarator() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1756); ptrabstractdeclarator();
				}
				break;
			...
			case 2:
				...
				case 1:
					{
					setState(1757); noptrabstractdeclarator(0);
					}
					break;
				}
				setState(1760); parametersandqualifiers();
				setState(1761); trailingreturntype();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1763); abstractpackdeclarator();
				}
				break;
			}
		}
	...
	public final PtrabstractdeclaratorContext ptrabstractdeclarator() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 2);
				{
				setState(1767); ptroperator();
				setState(1769);
				switch ( getInterpreter().adaptivePredict(_input,195,_ctx) ) {
				case 1:
					{
					setState(1768); ptrabstractdeclarator();
					}
					break;
				}
				}
	...
	private NoptrabstractdeclaratorContext noptrabstractdeclarator(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1774); parametersandqualifiers();
				}
				break;

			case 2:
				{
				setState(1775); match(LeftBracket);
				setState(1777);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << Alignof) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Const_cast) | (1L << Decltype) | (1L << Delete) | (1L << Double) | (1L << Dynamic_cast) | (1L << False) | (1L << Float) | (1L << Int) | (1L << Long) | (1L << New) | (1L << Noexcept) | (1L << Nullptr) | (1L << Operator) | (1L << Reinterpret_cast) | (1L << Short) | (1L << Signed) | (1L << Sizeof))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (Static_cast - 64)) | (1L << (This - 64)) | (1L << (True - 64)) | (1L << (Typeid_ - 64)) | (1L << (Typename_ - 64)) | (1L << (Unsigned - 64)) | (1L << (Void - 64)) | (1L << (Wchar - 64)) | (1L << (LeftParen - 64)) | (1L << (LeftBracket - 64)) | (1L << (Plus - 64)) | (1L << (Minus - 64)) | (1L << (Star - 64)) | (1L << (And - 64)) | (1L << (Or - 64)) | (1L << (Tilde - 64)) | (1L << (PlusPlus - 64)) | (1L << (MinusMinus - 64)))) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (Doublecolon - 128)) | (1L << (Identifier - 128)) | (1L << (Integerliteral - 128)) | (1L << (Characterliteral - 128)) | (1L << (Floatingliteral - 128)) | (1L << (Stringliteral - 128)) | (1L << (Userdefinedintegerliteral - 128)) | (1L << (Userdefinedfloatingliteral - 128)) | (1L << (Userdefinedstringliteral - 128)) | (1L << (Userdefinedcharacterliteral - 128)))) != 0)) {
					{
					setState(1776); constantexpression();
					}
				}

				setState(1779); match(RightBracket);
				setState(1781);
				switch ( getInterpreter().adaptivePredict(_input,198,_ctx) ) {
				case 1:
					{
					setState(1780); attributespecifierseq(0);
					}
					break;
				}
				}
			...
			case 3:
				{
				setState(1783); match(LeftParen);
				setState(1784); ptrabstractdeclarator();
				setState(1785); match(RightParen);
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(1790); parametersandqualifiers();
						}
						break;
					...
					case 2:
						...
						setState(1791);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(1792); match(LeftBracket);
						setState(1794);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << Alignof) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Const_cast) | (1L << Decltype) | (1L << Delete) | (1L << Double) | (1L << Dynamic_cast) | (1L << False) | (1L << Float) | (1L << Int) | (1L << Long) | (1L << New) | (1L << Noexcept) | (1L << Nullptr) | (1L << Operator) | (1L << Reinterpret_cast) | (1L << Short) | (1L << Signed) | (1L << Sizeof))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (Static_cast - 64)) | (1L << (This - 64)) | (1L << (True - 64)) | (1L << (Typeid_ - 64)) | (1L << (Typename_ - 64)) | (1L << (Unsigned - 64)) | (1L << (Void - 64)) | (1L << (Wchar - 64)) | (1L << (LeftParen - 64)) | (1L << (LeftBracket - 64)) | (1L << (Plus - 64)) | (1L << (Minus - 64)) | (1L << (Star - 64)) | (1L << (And - 64)) | (1L << (Or - 64)) | (1L << (Tilde - 64)) | (1L << (PlusPlus - 64)) | (1L << (MinusMinus - 64)))) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (Doublecolon - 128)) | (1L << (Identifier - 128)) | (1L << (Integerliteral - 128)) | (1L << (Characterliteral - 128)) | (1L << (Floatingliteral - 128)) | (1L << (Stringliteral - 128)) | (1L << (Userdefinedintegerliteral - 128)) | (1L << (Userdefinedfloatingliteral - 128)) | (1L << (Userdefinedstringliteral - 128)) | (1L << (Userdefinedcharacterliteral - 128)))) != 0)) {
							{
							setState(1793); constantexpression();
							}
						}

						setState(1796); match(RightBracket);
						setState(1798);
						switch ( getInterpreter().adaptivePredict(_input,201,_ctx) ) {
						case 1:
							{
							setState(1797); attributespecifierseq(0);
							}
							break;
						}
						}
	...
	public final AbstractpackdeclaratorContext abstractpackdeclarator() throws RecognitionException {
		...
		try {
			...
			case Ellipsis:
				enterOuterAlt(_localctx, 1);
				{
				setState(1805); noptrabstractpackdeclarator(0);
				}
				break;
			case 2:
			case Decltype:
			...
			case Identifier:
				enterOuterAlt(_localctx, 2);
				{
				setState(1806); ptroperator();
				setState(1807); abstractpackdeclarator();
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(1814);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(1815); parametersandqualifiers();
						}
						break;
					...
					case 2:
						...
						setState(1816);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(1817); match(LeftBracket);
						setState(1819);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << Alignof) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Const_cast) | (1L << Decltype) | (1L << Delete) | (1L << Double) | (1L << Dynamic_cast) | (1L << False) | (1L << Float) | (1L << Int) | (1L << Long) | (1L << New) | (1L << Noexcept) | (1L << Nullptr) | (1L << Operator) | (1L << Reinterpret_cast) | (1L << Short) | (1L << Signed) | (1L << Sizeof))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (Static_cast - 64)) | (1L << (This - 64)) | (1L << (True - 64)) | (1L << (Typeid_ - 64)) | (1L << (Typename_ - 64)) | (1L << (Unsigned - 64)) | (1L << (Void - 64)) | (1L << (Wchar - 64)) | (1L << (LeftParen - 64)) | (1L << (LeftBracket - 64)) | (1L << (Plus - 64)) | (1L << (Minus - 64)) | (1L << (Star - 64)) | (1L << (And - 64)) | (1L << (Or - 64)) | (1L << (Tilde - 64)) | (1L << (PlusPlus - 64)) | (1L << (MinusMinus - 64)))) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (Doublecolon - 128)) | (1L << (Identifier - 128)) | (1L << (Integerliteral - 128)) | (1L << (Characterliteral - 128)) | (1L << (Floatingliteral - 128)) | (1L << (Stringliteral - 128)) | (1L << (Userdefinedintegerliteral - 128)) | (1L << (Userdefinedfloatingliteral - 128)) | (1L << (Userdefinedstringliteral - 128)) | (1L << (Userdefinedcharacterliteral - 128)))) != 0)) {
							{
							setState(1818); constantexpression();
							}
						}

						setState(1821); match(RightBracket);
						setState(1823);
						switch ( getInterpreter().adaptivePredict(_input,206,_ctx) ) {
						case 1:
							{
							setState(1822); attributespecifierseq(0);
							}
							break;
						}
						}
		...
		try {
			...
			case 1:
				...
				if (((((_la - 9)) & ~0x3f) == 0 && ((1L << (_la - 9)) & ((1L << (Alignas - 9)) | (1L << (Auto - 9)) | (1L << (Bool - 9)) | (1L << (Char - 9)) | (1L << (Char16 - 9)) | (1L << (Char32 - 9)) | (1L << (Class - 9)) | (1L << (Const - 9)) | (1L << (Constexpr - 9)) | (1L << (Decltype - 9)) | (1L << (Double - 9)) | (1L << (Enum - 9)) | (1L << (Explicit - 9)) | (1L << (Extern - 9)) | (1L << (Float - 9)) | (1L << (Friend - 9)) | (1L << (Inline - 9)) | (1L << (Int - 9)) | (1L << (Long - 9)) | (1L << (Mutable - 9)) | (1L << (Register - 9)) | (1L << (Short - 9)) | (1L << (Signed - 9)) | (1L << (Static - 9)) | (1L << (Struct - 9)) | (1L << (Thread_local - 9)))) != 0) || ((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & ((1L << (Typedef - 73)) | (1L << (Typename_ - 73)) | (1L << (Union - 73)) | (1L << (Unsigned - 73)) | (1L << (Virtual - 73)) | (1L << (Void - 73)) | (1L << (Volatile - 73)) | (1L << (Wchar - 73)) | (1L << (LeftBracket - 73)) | (1L << (Doublecolon - 73)) | (1L << (Identifier - 73)))) != 0)) {
					{
					setState(1830); parameterdeclarationlist(0);
					}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1836); parameterdeclarationlist(0);
	...
	private ParameterdeclarationlistContext parameterdeclarationlist(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(1843); parameterdeclaration();
			}
			_ctx.stop = _input.LT(-1);
			setState(1850);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(1847); parameterdeclaration();
					}
					} 
				}
				setState(1852);
	...
	public final ParameterdeclarationContext parameterdeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(1853); attributespecifierseq(0);
					}
				}

				setState(1856); declspecifierseq();
				setState(1857); declarator();
				}
				break;
			...
			case 2:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(1859); attributespecifierseq(0);
					}
				}

				setState(1862); declspecifierseq();
				setState(1863); declarator();
				setState(1864); match(Assign);
				setState(1865); initializerclause();
				}
				break;
			...
			case 3:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(1867); attributespecifierseq(0);
					}
				}

				setState(1870); declspecifierseq();
				setState(1872);
				switch ( getInterpreter().adaptivePredict(_input,216,_ctx) ) {
				case 1:
					{
					setState(1871); abstractdeclarator();
					}
					break;
				}
				}
			...
			case 4:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(1874); attributespecifierseq(0);
					}
				}

				setState(1877); declspecifierseq();
				setState(1879);
				_la = _input.LA(1);
				if (_la==2 || _la==Decltype || ((((_la - 84)) & ~0x3f) == 0 && ((1L << (_la - 84)) & ((1L << (LeftParen - 84)) | (1L << (LeftBracket - 84)) | (1L << (Star - 84)) | (1L << (And - 84)) | (1L << (Doublecolon - 84)) | (1L << (Ellipsis - 84)) | (1L << (Identifier - 84)))) != 0)) {
					{
					setState(1878); abstractdeclarator();
					}
				}

				setState(1881); match(Assign);
				setState(1882); initializerclause();
				}
				break;
			}
		}
	...
	public final FunctiondefinitionContext functiondefinition() throws RecognitionException {
		...
		try {
			...
			if (_la==Alignas || _la==LeftBracket) {
				{
				setState(1886); attributespecifierseq(0);
				}
			}
			...
			case 1:
				{
				setState(1889); declspecifierseq();
				}
				break;
			}
			setState(1892); declarator();
			setState(1894);
			_la = _input.LA(1);
			if (_la==Final || _la==Override) {
				{
				setState(1893); virtspecifierseq(0);
				}
			}

			setState(1896); functionbody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FunctionbodyContext functionbody() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==Colon) {
					{
					setState(1898); ctorinitializer();
					}
				}

				setState(1901); compoundstatement();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1902); functiontryblock();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1903); match(Assign);
				setState(1904); match(Default);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(1906); match(Assign);
				setState(1907); match(Delete);
				setState(1908); match(Semi);
				}
				break;
			}
		}
	...
	public final InitializerContext initializer() throws RecognitionException {
		...
		try {
			...
			case Assign:
				enterOuterAlt(_localctx, 1);
				{
				setState(1911); braceorequalinitializer();
				}
				break;
			case LeftParen:
				enterOuterAlt(_localctx, 2);
				{
				setState(1912); match(LeftParen);
				setState(1913); expressionlist();
				setState(1914); match(RightParen);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final BraceorequalinitializerContext braceorequalinitializer() throws RecognitionException {
		...
		try {
			...
			case Assign:
				...
				setState(1919); initializerclause();
				}
				break;
			case LeftBrace:
				enterOuterAlt(_localctx, 2);
				{
				setState(1920); bracedinitlist();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final InitializerclauseContext initializerclause() throws RecognitionException {
		...
		try {
			...
			case Userdefinedcharacterliteral:
				enterOuterAlt(_localctx, 1);
				{
				setState(1923); assignmentexpression();
				}
				break;
			case LeftBrace:
				enterOuterAlt(_localctx, 2);
				{
				setState(1924); bracedinitlist();
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(1934); initializerclause();
					setState(1936);
					switch ( getInterpreter().adaptivePredict(_input,229,_ctx) ) {
					case 1:
						{
						setState(1935); match(Ellipsis);
						}
						break;
					}
					}
	...
	public final BracedinitlistContext bracedinitlist() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1943); match(LeftBrace);
				setState(1944); initializerlist(0);
				setState(1946);
				_la = _input.LA(1);
				if (_la==Comma) {
					{
				...
				setState(1948); match(RightBrace);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1950); match(LeftBrace);
				setState(1951); match(RightBrace);
				}
				break;
			}
		}
	...
	public final ClassnameContext classname() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1954); match(Identifier);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1955); simpletemplateid();
				}
				break;
			}
		}
	...
	public final ClassheadContext classhead() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1965); classkey();
				setState(1967);
				_la = _input.LA(1);
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(1966); attributespecifierseq(0);
					}
				}

				setState(1969); classheadname();
				setState(1971);
				_la = _input.LA(1);
				if (_la==Final) {
					{
					setState(1970); classvirtspecifier();
					}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1976); classkey();
				setState(1978);
				_la = _input.LA(1);
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(1977); attributespecifierseq(0);
					}
				}
	...
	public final ClassheadnameContext classheadname() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1985); nestednamespecifier(0);
				}
				break;
			}
			setState(1988); classname();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MemberspecificationContext memberspecification() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 1);
				{
				setState(1994); memberdeclaration();
				setState(1996);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << Alignas) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Class) | (1L << Const) | (1L << Constexpr) | (1L << Decltype) | (1L << Double) | (1L << Enum) | (1L << Explicit) | (1L << Extern) | (1L << Float) | (1L << Friend) | (1L << Inline) | (1L << Int) | (1L << Long) | (1L << Mutable) | (1L << Operator) | (1L << Private) | (1L << Protected) | (1L << Public) | (1L << Register) | (1L << Short) | (1L << Signed) | (1L << Static) | (1L << Static_assert))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (Struct - 65)) | (1L << (Template - 65)) | (1L << (Thread_local - 65)) | (1L << (Typedef - 65)) | (1L << (Typename_ - 65)) | (1L << (Union - 65)) | (1L << (Unsigned - 65)) | (1L << (Using - 65)) | (1L << (Virtual - 65)) | (1L << (Void - 65)) | (1L << (Volatile - 65)) | (1L << (Wchar - 65)) | (1L << (LeftParen - 65)) | (1L << (LeftBracket - 65)) | (1L << (Star - 65)) | (1L << (And - 65)) | (1L << (Tilde - 65)) | (1L << (Colon - 65)) | (1L << (Doublecolon - 65)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (Semi - 129)) | (1L << (Ellipsis - 129)) | (1L << (Identifier - 129)))) != 0)) {
					{
					setState(1995); memberspecification();
					}
				}
			...
			case Public:
				enterOuterAlt(_localctx, 2);
				{
				setState(1998); accessspecifier();
				setState(1999); match(Colon);
				setState(2001);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << Alignas) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Class) | (1L << Const) | (1L << Constexpr) | (1L << Decltype) | (1L << Double) | (1L << Enum) | (1L << Explicit) | (1L << Extern) | (1L << Float) | (1L << Friend) | (1L << Inline) | (1L << Int) | (1L << Long) | (1L << Mutable) | (1L << Operator) | (1L << Private) | (1L << Protected) | (1L << Public) | (1L << Register) | (1L << Short) | (1L << Signed) | (1L << Static) | (1L << Static_assert))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (Struct - 65)) | (1L << (Template - 65)) | (1L << (Thread_local - 65)) | (1L << (Typedef - 65)) | (1L << (Typename_ - 65)) | (1L << (Union - 65)) | (1L << (Unsigned - 65)) | (1L << (Using - 65)) | (1L << (Virtual - 65)) | (1L << (Void - 65)) | (1L << (Volatile - 65)) | (1L << (Wchar - 65)) | (1L << (LeftParen - 65)) | (1L << (LeftBracket - 65)) | (1L << (Star - 65)) | (1L << (And - 65)) | (1L << (Tilde - 65)) | (1L << (Colon - 65)) | (1L << (Doublecolon - 65)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (Semi - 129)) | (1L << (Ellipsis - 129)) | (1L << (Identifier - 129)))) != 0)) {
					{
	...
	public final MemberdeclarationContext memberdeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					setState(2005); attributespecifierseq(0);
					}
					break;
				}
				setState(2009);
				...
				case 1:
					{
					setState(2008); declspecifierseq();
					}
					break;
				}
				setState(2012);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << Alignas) | (1L << Decltype) | (1L << Operator))) != 0) || ((((_la - 84)) & ~0x3f) == 0 && ((1L << (_la - 84)) & ((1L << (LeftParen - 84)) | (1L << (LeftBracket - 84)) | (1L << (Star - 84)) | (1L << (And - 84)) | (1L << (Tilde - 84)) | (1L << (Colon - 84)) | (1L << (Doublecolon - 84)) | (1L << (Ellipsis - 84)) | (1L << (Identifier - 84)))) != 0)) {
					{
					setState(2011); memberdeclaratorlist(0);
					}
				}

				setState(2014); match(Semi);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2015); functiondefinition();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(2016); usingdeclaration();
				}
				break;
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(2017); static_assertdeclaration();
				}
				break;
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(2018); templatedeclaration();
				}
				break;
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(2019); aliasdeclaration();
				}
				break;
			...
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(2020); emptydeclaration();
				}
				break;
			}
		}
	...
	private MemberdeclaratorlistContext memberdeclaratorlist(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(2024); memberdeclarator();
			}
			_ctx.stop = _input.LT(-1);
			setState(2031);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(2028); memberdeclarator();
					}
					} 
				}
				setState(2033);
	...
	public final MemberdeclaratorContext memberdeclarator() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2034); declarator();
				setState(2036);
				switch ( getInterpreter().adaptivePredict(_input,250,_ctx) ) {
				case 1:
					{
					setState(2035); virtspecifierseq(0);
					}
					break;
				}
				setState(2039);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2041); declarator();
				setState(2043);
				switch ( getInterpreter().adaptivePredict(_input,252,_ctx) ) {
				case 1:
					{
					setState(2042); braceorequalinitializer();
					}
					break;
				}
				}
			...
			case 3:
				...
				setState(2051); match(Colon);
				setState(2052); constantexpression();
				}
				break;
			}
		}
	...
	public final PurespecifierContext purespecifier() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2067); match(Assign);
			setState(2068); ((PurespecifierContext)_localctx).val = match(Octalliteral);
	...
	public final BaseclauseContext baseclause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2071); match(Colon);
			setState(2072); basespecifierlist(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private BasespecifierlistContext basespecifierlist(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(2075); basespecifier();
			setState(2077);
			switch ( getInterpreter().adaptivePredict(_input,257,_ctx) ) {
			case 1:
				{
				setState(2076); match(Ellipsis);
				}
				break;
			}
			}
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(2081); basespecifier();
					setState(2083);
					switch ( getInterpreter().adaptivePredict(_input,258,_ctx) ) {
					case 1:
						{
						setState(2082); match(Ellipsis);
						}
						break;
					}
					}
	...
	public final BasespecifierContext basespecifier() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(2093); basetypespecifier();
				}
				break;
			...
			case 2:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(2094); attributespecifierseq(0);
					}
				}

				setState(2097); match(Virtual);
				setState(2099);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Private) | (1L << Protected) | (1L << Public))) != 0)) {
					{
					setState(2098); accessspecifier();
					}
				}

				setState(2101); basetypespecifier();
				}
				break;
			...
			case 3:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(2102); attributespecifierseq(0);
					}
				}

				setState(2105); accessspecifier();
				setState(2107);
				_la = _input.LA(1);
				if (_la==Virtual) {
					{
				...
				setState(2109); basetypespecifier();
				}
				break;
			}
		}
	...
	public final ClassordecltypeContext classordecltype() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					setState(2113); nestednamespecifier(0);
					}
					break;
				}
				setState(2116); classname();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2117); decltypespecifier();
				}
				break;
			}
		}
	...
	public final ConversionfunctionidContext conversionfunctionid() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2124); match(Operator);
			setState(2125); conversiontypeid();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConversiontypeidContext conversiontypeid() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2127); typespecifierseq();
			setState(2129);
			switch ( getInterpreter().adaptivePredict(_input,268,_ctx) ) {
			case 1:
				{
				setState(2128); conversiondeclarator();
				}
				break;
			}
			}
	...
	public final ConversiondeclaratorContext conversiondeclarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2131); ptroperator();
			setState(2133);
			switch ( getInterpreter().adaptivePredict(_input,269,_ctx) ) {
			case 1:
				{
				setState(2132); conversiondeclarator();
				}
				break;
			}
			}
	...
	public final CtorinitializerContext ctorinitializer() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2135); match(Colon);
			setState(2136); meminitializerlist();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MeminitializerlistContext meminitializerlist() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2138); meminitializer();
				setState(2140);
				_la = _input.LA(1);
				if (_la==Ellipsis) {
					{
					setState(2139); match(Ellipsis);
					}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2142); meminitializer();
				setState(2144);
				_la = _input.LA(1);
				if (_la==Ellipsis) {
					{
					setState(2143); match(Ellipsis);
					}
				}

				setState(2146); match(Comma);
				setState(2147); meminitializerlist();
				}
				break;
			}
		}
	...
	public final MeminitializerContext meminitializer() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2151); meminitializerid();
				setState(2152); match(LeftParen);
				setState(2154);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << Alignof) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Const_cast) | (1L << Decltype) | (1L << Delete) | (1L << Double) | (1L << Dynamic_cast) | (1L << False) | (1L << Float) | (1L << Int) | (1L << Long) | (1L << New) | (1L << Noexcept) | (1L << Nullptr) | (1L << Operator) | (1L << Reinterpret_cast) | (1L << Short) | (1L << Signed) | (1L << Sizeof))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (Static_cast - 64)) | (1L << (This - 64)) | (1L << (Throw - 64)) | (1L << (True - 64)) | (1L << (Typeid_ - 64)) | (1L << (Typename_ - 64)) | (1L << (Unsigned - 64)) | (1L << (Void - 64)) | (1L << (Wchar - 64)) | (1L << (LeftParen - 64)) | (1L << (LeftBracket - 64)) | (1L << (LeftBrace - 64)) | (1L << (Plus - 64)) | (1L << (Minus - 64)) | (1L << (Star - 64)) | (1L << (And - 64)) | (1L << (Or - 64)) | (1L << (Tilde - 64)) | (1L << (PlusPlus - 64)) | (1L << (MinusMinus - 64)))) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (Doublecolon - 128)) | (1L << (Identifier - 128)) | (1L << (Integerliteral - 128)) | (1L << (Characterliteral - 128)) | (1L << (Floatingliteral - 128)) | (1L << (Stringliteral - 128)) | (1L << (Userdefinedintegerliteral - 128)) | (1L << (Userdefinedfloatingliteral - 128)) | (1L << (Userdefinedstringliteral - 128)) | (1L << (Userdefinedcharacterliteral - 128)))) != 0)) {
					{
					setState(2153); expressionlist();
					}
				}

				setState(2156); match(RightParen);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2158); meminitializerid();
				setState(2159); bracedinitlist();
				}
				break;
			}
		}
	...
	public final OperatorfunctionidContext operatorfunctionid() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2167); match(Operator);
			setState(2168); theoperator();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LiteraloperatoridContext literaloperatorid() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2170); match(Operator);
				setState(2171); match(Stringliteral);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2173); match(Operator);
				setState(2174); match(Userdefinedstringliteral);
				}
				break;
			}
		}
	...
	public final TemplatedeclarationContext templatedeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2177); match(Template);
			setState(2178); match(Less);
			setState(2179); templateparameterlist(0);
			setState(2180); match(Greater);
			setState(2181); declaration();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private TemplateparameterlistContext templateparameterlist(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(2184); templateparameter();
			}
			_ctx.stop = _input.LT(-1);
			setState(2191);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(2188); templateparameter();
					}
					} 
				}
				setState(2193);
	...
	public final TemplateparameterContext templateparameter() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2195); parameterdeclaration();
				}
				break;
			}
		}
	...
	public final TypeparameterContext typeparameter() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2198); match(Class);
				setState(2200);
				switch ( getInterpreter().adaptivePredict(_input,279,_ctx) ) {
				case 1:
					{
					setState(2199); match(Ellipsis);
					}
					break;
				}
				setState(2203);
			...
			case 2:
				...
				setState(2209); match(Assign);
				setState(2210); thetypeid();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(2211); match(Typename_);
				setState(2213);
				switch ( getInterpreter().adaptivePredict(_input,282,_ctx) ) {
				case 1:
					{
					setState(2212); match(Ellipsis);
					}
					break;
				}
				setState(2216);
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(2224); match(Template);
				setState(2225); match(Less);
				setState(2226); templateparameterlist(0);
				setState(2227); match(Greater);
				setState(2228); match(Class);
				setState(2230);
				switch ( getInterpreter().adaptivePredict(_input,285,_ctx) ) {
				case 1:
					{
					setState(2229); match(Ellipsis);
					}
					break;
				}
				setState(2233);
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(2235); match(Template);
				setState(2236); match(Less);
				setState(2237); templateparameterlist(0);
				setState(2238); match(Greater);
				setState(2239); match(Class);
				setState(2241);
				_la = _input.LA(1);
				if (_la==Identifier) {
					{
				...
				setState(2243); match(Assign);
				setState(2244); idexpression();
				}
				break;
			}
		}
	...
	public final TemplateidContext templateid() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2255); simpletemplateid();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2256); operatorfunctionid();
				setState(2257); match(Less);
				setState(2259);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << Alignof) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Class) | (1L << Const) | (1L << Const_cast) | (1L << Decltype) | (1L << Delete) | (1L << Double) | (1L << Dynamic_cast) | (1L << Enum) | (1L << False) | (1L << Float) | (1L << Int) | (1L << Long) | (1L << New) | (1L << Noexcept) | (1L << Nullptr) | (1L << Operator) | (1L << Reinterpret_cast) | (1L << Short) | (1L << Signed) | (1L << Sizeof))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (Static_cast - 64)) | (1L << (Struct - 64)) | (1L << (This - 64)) | (1L << (True - 64)) | (1L << (Typeid_ - 64)) | (1L << (Typename_ - 64)) | (1L << (Union - 64)) | (1L << (Unsigned - 64)) | (1L << (Void - 64)) | (1L << (Volatile - 64)) | (1L << (Wchar - 64)) | (1L << (LeftParen - 64)) | (1L << (LeftBracket - 64)) | (1L << (Plus - 64)) | (1L << (Minus - 64)) | (1L << (Star - 64)) | (1L << (And - 64)) | (1L << (Or - 64)) | (1L << (Tilde - 64)) | (1L << (PlusPlus - 64)) | (1L << (MinusMinus - 64)))) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (Doublecolon - 128)) | (1L << (Identifier - 128)) | (1L << (Integerliteral - 128)) | (1L << (Characterliteral - 128)) | (1L << (Floatingliteral - 128)) | (1L << (Stringliteral - 128)) | (1L << (Userdefinedintegerliteral - 128)) | (1L << (Userdefinedfloatingliteral - 128)) | (1L << (Userdefinedstringliteral - 128)) | (1L << (Userdefinedcharacterliteral - 128)))) != 0)) {
					{
					setState(2258); templateargumentlist(0);
					}
				}

				setState(2261); match(Greater);
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(2263); literaloperatorid();
				setState(2264); match(Less);
				setState(2266);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 6) | (1L << Alignof) | (1L << Auto) | (1L << Bool) | (1L << Char) | (1L << Char16) | (1L << Char32) | (1L << Class) | (1L << Const) | (1L << Const_cast) | (1L << Decltype) | (1L << Delete) | (1L << Double) | (1L << Dynamic_cast) | (1L << Enum) | (1L << False) | (1L << Float) | (1L << Int) | (1L << Long) | (1L << New) | (1L << Noexcept) | (1L << Nullptr) | (1L << Operator) | (1L << Reinterpret_cast) | (1L << Short) | (1L << Signed) | (1L << Sizeof))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (Static_cast - 64)) | (1L << (Struct - 64)) | (1L << (This - 64)) | (1L << (True - 64)) | (1L << (Typeid_ - 64)) | (1L << (Typename_ - 64)) | (1L << (Union - 64)) | (1L << (Unsigned - 64)) | (1L << (Void - 64)) | (1L << (Volatile - 64)) | (1L << (Wchar - 64)) | (1L << (LeftParen - 64)) | (1L << (LeftBracket - 64)) | (1L << (Plus - 64)) | (1L << (Minus - 64)) | (1L << (Star - 64)) | (1L << (And - 64)) | (1L << (Or - 64)) | (1L << (Tilde - 64)) | (1L << (PlusPlus - 64)) | (1L << (MinusMinus - 64)))) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (Doublecolon - 128)) | (1L << (Identifier - 128)) | (1L << (Integerliteral - 128)) | (1L << (Characterliteral - 128)) | (1L << (Floatingliteral - 128)) | (1L << (Stringliteral - 128)) | (1L << (Userdefinedintegerliteral - 128)) | (1L << (Userdefinedfloatingliteral - 128)) | (1L << (Userdefinedstringliteral - 128)) | (1L << (Userdefinedcharacterliteral - 128)))) != 0)) {
					{
					setState(2265); templateargumentlist(0);
					}
				}

				setState(2268); match(Greater);
				}
				break;
			}
		}
	...
	private TemplateargumentlistContext templateargumentlist(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(2275); templateargument();
			setState(2277);
			switch ( getInterpreter().adaptivePredict(_input,293,_ctx) ) {
			case 1:
				{
				setState(2276); match(Ellipsis);
				}
				break;
			}
			}
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(2279);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(2280); match(Comma);
					setState(2281); templateargument();
					setState(2283);
					switch ( getInterpreter().adaptivePredict(_input,294,_ctx) ) {
					case 1:
						{
						setState(2282); match(Ellipsis);
						}
						break;
					}
					}
	...
	public final TemplateargumentContext templateargument() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2291); constantexpression();
				}
				break;
	...
	public final TypenamespecifierContext typenamespecifier() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2295); match(Typename_);
				setState(2296); nestednamespecifier(0);
				setState(2297); match(Identifier);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(2299); match(Typename_);
				setState(2300); nestednamespecifier(0);
				setState(2302);
				_la = _input.LA(1);
				if (_la==Template) {
					{
					setState(2301); match(Template);
					}
				}

				setState(2304); simpletemplateid();
				}
				break;
			}
		}
	...
	public final ExplicitinstantiationContext explicitinstantiation() throws RecognitionException {
		...
		try {
			...
			if (_la==Extern) {
				{
				setState(2308); match(Extern);
				}
			}

			setState(2311); match(Template);
			setState(2312); declaration();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ExplicitspecializationContext explicitspecialization() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2314); match(Template);
			setState(2315); match(Less);
			setState(2316); match(Greater);
	...
	public final TryblockContext tryblock() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2319); match(Try);
			setState(2320); compoundstatement();
			setState(2321); handlerseq();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FunctiontryblockContext functiontryblock() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2323); match(Try);
			setState(2325);
			_la = _input.LA(1);
			if (_la==Colon) {
				{
				setState(2324); ctorinitializer();
				}
			}

			setState(2327); compoundstatement();
			setState(2328); handlerseq();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final HandlerseqContext handlerseq() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2330); handler();
			setState(2332);
			switch ( getInterpreter().adaptivePredict(_input,301,_ctx) ) {
			case 1:
				{
				setState(2331); handlerseq();
				}
				break;
			}
			}
	...
	public final HandlerContext handler() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2334); match(Catch);
			setState(2335); match(LeftParen);
			setState(2336); exceptiondeclaration();
			setState(2337); match(RightParen);
			setState(2338); compoundstatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ExceptiondeclarationContext exceptiondeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(2340); attributespecifierseq(0);
					}
				}

				setState(2343); typespecifierseq();
				setState(2344); declarator();
				}
				break;
			...
			case 2:
				...
				if (_la==Alignas || _la==LeftBracket) {
					{
					setState(2346); attributespecifierseq(0);
					}
				}

				setState(2349); typespecifierseq();
				setState(2351);
				_la = _input.LA(1);
				if (_la==2 || _la==Decltype || ((((_la - 84)) & ~0x3f) == 0 && ((1L << (_la - 84)) & ((1L << (LeftParen - 84)) | (1L << (LeftBracket - 84)) | (1L << (Star - 84)) | (1L << (And - 84)) | (1L << (Doublecolon - 84)) | (1L << (Ellipsis - 84)) | (1L << (Identifier - 84)))) != 0)) {
					{
					setState(2350); abstractdeclarator();
					}
				}
	...
	public final ThrowexpressionContext throwexpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2356); match(Throw);
			setState(2358);
			switch ( getInterpreter().adaptivePredict(_input,306,_ctx) ) {
			case 1:
				{
				setState(2357); assignmentexpression();
				}
				break;
			}
			}
	...
	public final ExceptionspecificationContext exceptionspecification() throws RecognitionException {
		...
		try {
			...
			case Throw:
				enterOuterAlt(_localctx, 1);
				{
				setState(2360); dynamicexceptionspecification();
				}
				break;
			case Noexcept:
				enterOuterAlt(_localctx, 2);
				{
				setState(2361); noexceptspecification();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final DynamicexceptionspecificationContext dynamicexceptionspecification() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2364); match(Throw);
			setState(2365); match(LeftParen);
			setState(2367);
			_la = _input.LA(1);
			if (((((_la - 12)) & ~0x3f) == 0 && ((1L << (_la - 12)) & ((1L << (Auto - 12)) | (1L << (Bool - 12)) | (1L << (Char - 12)) | (1L << (Char16 - 12)) | (1L << (Char32 - 12)) | (1L << (Class - 12)) | (1L << (Const - 12)) | (1L << (Decltype - 12)) | (1L << (Double - 12)) | (1L << (Enum - 12)) | (1L << (Float - 12)) | (1L << (Int - 12)) | (1L << (Long - 12)) | (1L << (Short - 12)) | (1L << (Signed - 12)) | (1L << (Struct - 12)) | (1L << (Typename_ - 12)))) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & ((1L << (Union - 76)) | (1L << (Unsigned - 76)) | (1L << (Void - 76)) | (1L << (Volatile - 76)) | (1L << (Wchar - 76)) | (1L << (Doublecolon - 76)) | (1L << (Identifier - 76)))) != 0)) {
				{
				setState(2366); typeidlist(0);
				}
			}

			setState(2369); match(RightParen);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private TypeidlistContext typeidlist(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(2372); thetypeid();
			setState(2374);
			switch ( getInterpreter().adaptivePredict(_input,309,_ctx) ) {
			case 1:
				{
				setState(2373); match(Ellipsis);
				}
				break;
			}
			}
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(2376);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(2377); match(Comma);
					setState(2378); thetypeid();
					setState(2380);
					switch ( getInterpreter().adaptivePredict(_input,310,_ctx) ) {
					case 1:
						{
						setState(2379); match(Ellipsis);
						}
						break;
					}
					}
	...
	public final NoexceptspecificationContext noexceptspecification() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(2387); match(Noexcept);
				setState(2388); match(LeftParen);
				setState(2389); constantexpression();
				setState(2390); match(RightParen);
				}
				break;
	...
	public final TheoperatorContext theoperator() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				setState(2398); match(LeftBracket);
				setState(2399); match(RightBracket);
				}
				break;
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(2400); match(Delete);
				setState(2401); match(LeftBracket);
				setState(2402); match(RightBracket);
				}
				break;
			...
			case 19:
				...
				{
				setState(2417); match(PlusAssign);
				}
				break;
			...
			case 20:
				...
				{
				setState(2418); match(MinusAssign);
				}
				break;
			...
			case 21:
				...
				{
				setState(2419); match(StarAssign);
				}
				break;
			...
			case 28:
				...
				{
				setState(2426); match(RightShift);
				}
				break;
			...
			case 29:
				...
				{
				setState(2427); match(RightShiftAssign);
				}
				break;
			...
			case 30:
				...
				{
				setState(2428); match(LeftShiftAssign);
				}
				break;
			...
			case 34:
				...
				{
				setState(2432); match(GreaterEqual);
				}
				break;
			...
			case 40:
				...
				{
				setState(2438); match(MinusMinus);
				}
				break;
			...
			case 44:
				...
				{
				setState(2442); match(LeftParen);
				setState(2443); match(RightParen);
				}
				break;
			...
			case 45:
				...
				{
				setState(2444); match(LeftBracket);
				setState(2445); match(RightBracket);
				}
				break;
			}
		}
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			case Integerliteral:
				enterOuterAlt(_localctx, 1);
				{
				setState(2448); match(Integerliteral);
				}
				break;
			case Characterliteral:
				enterOuterAlt(_localctx, 2);
				{
				setState(2449); match(Characterliteral);
				}
				break;
			case Floatingliteral:
				enterOuterAlt(_localctx, 3);
				{
				setState(2450); match(Floatingliteral);
				}
				break;
			case Stringliteral:
				enterOuterAlt(_localctx, 4);
				{
				setState(2451); match(Stringliteral);
				}
				break;
			case False:
			case True:
				enterOuterAlt(_localctx, 5);
				{
				setState(2452); booleanliteral();
				}
				break;
			case Nullptr:
				enterOuterAlt(_localctx, 6);
				{
				setState(2453); pointerliteral();
				}
				break;
			case Userdefinedintegerliteral:
			case Userdefinedfloatingliteral:
			...
			case Userdefinedcharacterliteral:
				enterOuterAlt(_localctx, 7);
				{
				setState(2454); userdefinedliteral();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	private static final String _serializedATNSegment0 =
		...
		"\u0166\u0168\u016a\u016c\u016e\u0170\u0172\u0174\u0176\u0178\u017a\u017c"+
		"\u017e\u0180\u0182\u0184\u0186\u0188\u018a\u018c\u018e\u0190\2\17\4\2"+
		"bbff\6\2\6\6\b\b\\^bd\3\2qr\5\2ffipst\7\2%%\60\60::@@GG\5\2##--QQ\4\2"+
		"\27\27SS\4\2\4\4bb\5\2\26\26CCNN\4\2\'\'\66\66\3\2\679\4\2&&II\3\2\u0091"+
		"\u0094\u0abc\2\u0193\3\2\2\2\4\u019f\3\2\2\2\6\u01a3\3\2\2\2\b\u01ae\3"+
		"\2\2\2\n\u01b0\3\2\2\2\f\u01c1\3\2\2\2\16\u01d2\3\2\2\2\20\u01d8\3\2\2"+
		"\2\22\u01e4\3\2\2\2\24\u01e6\3\2\2\2\26\u01e8\3\2\2\2\30\u01fa\3\2\2\2"+
		"\32\u0200\3\2\2\2\34\u0207\3\2\2\2\36\u0209\3\2\2\2 \u0258\3\2\2\2\"\u0285"+
		"\3\2\2\2$\u0287\3\2\2\2&\u0289\3\2\2\2(\u02a1\3\2\2\2*\u02bf\3\2\2\2,"+
		"\u02c1\3\2\2\2.\u02db\3\2\2\2\60\u02dd\3\2\2\2\62\u02e1\3\2\2\2\64\u02ea"+
		"\3\2\2\2\66\u02ec\3\2\2\28\u0305\3\2\2\2:\u0313\3\2\2\2<\u0315\3\2\2\2"+
		">\u0320\3\2\2\2@\u0322\3\2\2\2B\u0330\3\2\2\2D\u0341\3\2\2\2F\u034f\3"+
		"\2\2\2H\u035b\3\2\2\2J\u035d\3\2\2\2L\u0371\3\2\2\2N\u037f\3\2\2\2P\u038a"+
		"\3\2\2\2R\u0395\3\2\2\2T\u03a0\3\2\2\2V\u03ae\3\2\2\2X\u03c3\3\2\2\2Z"+
